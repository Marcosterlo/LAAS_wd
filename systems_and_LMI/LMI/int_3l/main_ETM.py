...
class LMI_3l_int():
  def __init__(self, W, b):
    ...
    self.gamma1_scal = self.gammas[0]*0 + 1
    self.gamma2_scal = self.gammas[1]*0 + 1
    self.gamma3_scal = self.gammas[2]*0 + 1
    ...
    self.M2 = self.Rnu.T @ (self.R1.T @ (self.Omega1 + self.Omega1.T) @ self.R1 + self.R2.T @ (self.Omega2 + self.Omega2.T) @ self.R2 + self.R3.T @ (self.Omega3 + self.Omega3.T) @ self.R3) @ self.Rnu
    
    self.M_sat = self.Rsat.T @ (self.Omegas + self.Omegas.T) @ self.Rsat
    ...
    ]) + self.Rs.T @ self.Sinsec @ self.Rs - self.M2 - self.M_sat
