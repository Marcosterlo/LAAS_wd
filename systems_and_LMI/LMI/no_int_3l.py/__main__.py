...
if __name__ == "__main__":
  W1_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l1.weight.csv")
  W2_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l2.weight.csv")
  W3_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l3.weight.csv")
  W4_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l4.weight.csv")
  ...
  b1_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l1.bias.csv")
  b2_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l2.bias.csv")
  b3_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l3.bias.csv")
  b4_name = os.path.abspath(__file__ + "/../../../systems/simple_weights/l4.bias.csv")
