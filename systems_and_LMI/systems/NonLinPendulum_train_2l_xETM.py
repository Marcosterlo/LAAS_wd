...
class NonLinPendulum_train2l_xETM(NonLinPendulum_train2l):
...
if __name__ == "__main__":
  ...
  W1_name = os.path.abspath(__file__ + "/../nonlin_2l_xETM/l1.weight.csv")
  W2_name = os.path.abspath(__file__ + "/../nonlin_2l_xETM/l2.weight.csv")
  W3_name = os.path.abspath(__file__ + "/../nonlin_2l_xETM/l3.weight.csv")
  
  b1_name = os.path.abspath(__file__ + "/../nonlin_2l_xETM/l1.bias.csv")
  b2_name = os.path.abspath(__file__ + "/../nonlin_2l_xETM/l2.bias.csv")
  b3_name = os.path.abspath(__file__ + "/../nonlin_2l_xETM/l3.bias.csv")
